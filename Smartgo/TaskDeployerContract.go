...
// GetBalanceOfUser is a free data retrieval call binding the contract method 0x79982de4.
//
// Solidity: function getBalanceOfUser() view returns(uint256)
func (_TaskDeployerContract *TaskDeployerContractCaller) GetBalanceOfUser(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TaskDeployerContract.contract.Call(opts, &out, "getBalanceOfUser")
...
//
// Solidity: function getBalanceOfUser() view returns(uint256)
func (_TaskDeployerContract *TaskDeployerContractSession) GetBalanceOfUser() (*big.Int, error) {
	return _TaskDeployerContract.Contract.GetBalanceOfUser(&_TaskDeployerContract.CallOpts)
}

// GetBalanceOfUser is a free data retrieval call binding the contract method 0x79982de4.
//
// Solidity: function getBalanceOfUser() view returns(uint256)
func (_TaskDeployerContract *TaskDeployerContractCallerSession) GetBalanceOfUser() (*big.Int, error) {
	return _TaskDeployerContract.Contract.GetBalanceOfUser(&_TaskDeployerContract.CallOpts)
}
...
//
// Solidity: function cancelEvent(uint256 _timestamp) payable returns()
...
// ClaimTrust is a paid mutator transaction binding the contract method 0x286c6423.
//
// Solidity: function claimTrust(uint256 _timestamp) payable returns()
func (_TaskDeployerContract *TaskDeployerContractTransactor) ClaimTrust(opts *bind.TransactOpts, _timestamp *big.Int) (*types.Transaction, error) {
	return _TaskDeployerContract.contract.Transact(opts, "claimTrust", _timestamp)
}

// ClaimTrust is a paid mutator transaction binding the contract method 0x286c6423.
//
// Solidity: function claimTrust(uint256 _timestamp) payable returns()
func (_TaskDeployerContract *TaskDeployerContractSession) ClaimTrust(_timestamp *big.Int) (*types.Transaction, error) {
	return _TaskDeployerContract.Contract.ClaimTrust(&_TaskDeployerContract.TransactOpts, _timestamp)
}

// ClaimTrust is a paid mutator transaction binding the contract method 0x286c6423.
//
// Solidity: function claimTrust(uint256 _timestamp) payable returns()
func (_TaskDeployerContract *TaskDeployerContractTransactorSession) ClaimTrust(_timestamp *big.Int) (*types.Transaction, error) {
	return _TaskDeployerContract.Contract.ClaimTrust(&_TaskDeployerContract.TransactOpts, _timestamp)
}
