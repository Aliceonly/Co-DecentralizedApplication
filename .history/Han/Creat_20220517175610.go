...
func Creat(c *gin.Context) {
	...
	a,blockNumber:=contract.CreatNewEvent(ins, Txopts, taskname+taskcontent+taskplace1, taskplace2, tasktime, n)
	...
	err := mysql.Insert(taskname, add, taskplace2, task_money, times, "availablev", tasktime,blockNumber.String())
	if err != nil {
		panic(err)
	}
