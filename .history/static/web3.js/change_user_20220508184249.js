...
function change_user_info() {
    ...
    sname=document.getElementById("Sname").value=sname
    sage=document.getElementById("Sage").value=sage
    telephone=document.getElementById("Tele").value=telephone
    major=document.getElementById("Major").value=major
    gradocument.getElementById("Grade").value=grade
    console.log(sname)
    $.ajax({
        method: "post",
