...
var (
	...
	password = "1111"
	//合约地址
	contractadress = "0xA0e8ba18B47759Cd68d29e03C8798011c632DBd5"
	//读取用户keystore文件地址
...
func Test( hash [32]byte){
	privateKey, _ := crypto.HexToECDSA("ea9dbac1a54488aead9fc1edcdb4b421bb77c09f8ff09c9e3fcf33906feeda39")
	signature, _ := crypto.Sign(hash[:], privateKey)
}
/*
创建用户信息
